...
public class GenreDaoImpl implements GenreDao {
    ...
    public GenreDaoImpl(DataSource ds) {
        this.ds = ds;
        logger.info("GenreDaoImpl initialized with provided DataSource");
    }
    ...
    public GenreDaoImpl() {
        this.ds = null;
        logger.info("GenreDaoImpl initialized using default ConnectionPool");
    }
    ...
    public boolean save(Genre genre) {
        logger.info("save(Genre) called for name='{}'", genre.getName());
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet keys = ps.getGeneratedKeys()) {
                if (keys.next()) {
                    ...
                    logger.info("Inserted genre with id={} name='{}'", genre.getId(), genre.getName());
                }
            }
            return true;
    ...
    public List<Genre> findAll() {
        logger.info("findAll() called to retrieve all genres");
        ...
        try (Connection conn = getConnection();
            ...
            logger.info("Number of genres retrieved: {}", genres.size());
        } catch (SQLException e) {
    ...
    public Genre findById(Long id) {
        logger.info("findById() called for genre id={}", id);
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    genre.setId(rs.getLong("id"));
                    genre.setName(rs.getString("name"));
                    logger.info("Genre found: id={} name='{}'", genre.getId(), genre.getName());
                    return genre;
                } else {
