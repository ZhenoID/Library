...
public class AuthController {
    ...
    public String showRegisterForm(Model model) {
        logger.info("GET /register - displaying registration form");
    ...
    public String register(
        ...
        logger.info("POST /register - attempting to register user with username='{}'", user.getUsername());
        if (br.hasErrors()) {
            return "register";
        }
        try {
    ...
    public String login(@RequestParam String username,
                        ...
                        HttpSession session,
                        Model model) {
        logger.info("POST /login - attempting login for username='{}'", username);
    ...
    @GetMapping("/home")
    public String home() {
        logger.info("GET /home - displaying home page");
        return "home";
    }
    ...
    public String logout(HttpSession session) {
        logger.info("GET /logout - invalidating session and logging out");
        session.invalidate();
        return "redirect:/login";
    }
}
