...
public class AuthorServiceImpl implements AuthorService {
    ...
    public AuthorServiceImpl() {
        ...
        logger.info("AuthorServiceImpl initialized with default AuthorDaoImpl");
    }
    ...
    public AuthorServiceImpl(AuthorDao authorDao) {
        ...
        logger.info("AuthorServiceImpl initialized with provided AuthorDao");
    }
    ...
    public boolean save(Author author) {
        logger.info("save() called for author name='{}'", author.getName());
        boolean result = authorDao.save(author);
        if (result) {
            logger.info("Author saved with id={} name='{}'", author.getId(), author.getName());
        } else {
    ...
    public boolean update(Author author) {
        logger.info("update() called for author id={}, name='{}'", author.getId(), author.getName());
        boolean result = authorDao.update(author);
        if (result) {
            logger.info("Author updated successfully: id={} name='{}'", author.getId(), author.getName());
        } else {
    ...
    public boolean delete(Long id) {
        logger.info("delete() called for author id={}", id);
    ...
    public Author findById(Long id) {
        logger.info("findById() called for author id={}", id);
    ...
    public boolean existsById(Long id) {
        logger.info("existsById() called for author id={}", id);
