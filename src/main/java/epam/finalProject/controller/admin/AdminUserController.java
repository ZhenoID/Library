...
public class AdminUserController {
    ...
    public String showEditForm(
        ...
        logger.info("GET /admin/users/edit/{} - loading edit form for user", id);
        ...
        if ("ADMIN".equals(target.getRole()) && !editingSelf) {
            ra.addFlashAttribute("errorMessage", "Нельзя изменять роль другого администратора");
            return "redirect:/admin/users";
        }
    ...
    public String updateUserRole(
        ...
        logger.info("POST /admin/users/edit - updating role for user id={}", user.getId());
        ...
        try {
            ...
            ra.addFlashAttribute("errorMessage", "Ошибка при обновлении роли");
        }
        return "redirect:/admin/users";
    }
    ...
    public String deleteUser(
        ...
        if ("ADMIN".equals(target.getRole()) && !deletingSelf) {
            ra.addFlashAttribute("errorMessage", "Нельзя удалять другого администратора");
            return "redirect:/admin/users";
        }
        try {
            ...
            ra.addFlashAttribute("errorMessage", "Ошибка при удалении пользователя");
        }
        return "redirect:/admin/users";
    }
}
