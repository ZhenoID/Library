...
public class AuthorDaoImpl implements AuthorDao {
    ...
    public AuthorDaoImpl(DataSource ds) {
        this.ds = ds;
        logger.info("AuthorDaoImpl initialized with provided DataSource");
    }
    ...
    public AuthorDaoImpl() {
        this.ds = null;
        logger.info("AuthorDaoImpl initialized using default ConnectionPool");
    }
    ...
    public boolean save(Author author) {
        logger.info("save(Author) called for author name='{}'", author.getName());
        ...
        try (Connection conn = getConnection()) {
            ...
            try (PreparedStatement checkStmt = conn.prepareStatement(checkSql)) {
                ...
                if (rs.next()) {
                    ...
                    logger.info("Author already exists with id={} and name='{}'", existingId, author.getName());
                    return false;
                }
            }
            ...
            try (PreparedStatement insertStmt = conn.prepareStatement(insertSql, Statement.RETURN_GENERATED_KEYS)) {
                ...
                try (ResultSet keys = insertStmt.getGeneratedKeys()) {
                    if (keys.next()) {
                        ...
                        logger.info("Inserted new author with id={} and name='{}'", generatedId, author.getName());
                    }
                }
                return true;
            }
    ...
    public boolean update(Author author) {
        logger.info("update(Author) called for id={} name='{}'", author.getId(), author.getName());
        ...
        try (Connection conn = getConnection();
            ...
            if (rowsAffected > 0) {
                logger.info("Updated author id={} successfully", author.getId());
                return true;
            } else {
    ...
    public boolean delete(Long id) {
        logger.info("delete(id) called for author id={}", id);
        ...
        try (Connection conn = getConnection();
            ...
            int rowsAffected = ps.executeUpdate();
            if (rowsAffected > 0) {
                logger.info("Deleted author id={} successfully", id);
                return true;
            } else {
    ...
    public Author findById(Long id) {
        logger.info("findById(id) called for author id={}", id);
        ...
        try (Connection conn = getConnection();
            ...
            if (rs.next()) {
                ...
                logger.info("Author found: id={} name='{}'", author.getId(), author.getName());
                return author;
            } else {
    ...
    public List<Author> findAll() {
        logger.info("findAll() called to retrieve all authors");
        ...
        try (Connection conn = getConnection();
            ...
            logger.info("Number of authors retrieved: {}", authors.size());
        } catch (SQLException e) {
    ...
    public boolean existsById(Long id) {
        logger.info("existsById(id) called for author id={}", id);
        ...
        try (Connection conn = getConnection();
            ...
            logger.info("Author id={} exists: {}", id, exists);
            return exists;
