...
public class PurchaseHistoryController {
    ...
    public PurchaseHistoryController(PurchaseHistoryService historyService,
        ...
        logger.info("PurchaseHistoryController initialized");
    }
    ...
    public String viewHistory(Authentication auth, Model model) {
        ...
        logger.info("GET /purchase-history requested by user='{}'", username);
        ...
        logger.info("Added historyRows to model and returning purchase-history view");
