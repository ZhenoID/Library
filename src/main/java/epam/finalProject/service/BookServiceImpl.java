...
public class BookServiceImpl implements BookService {
    ...
    public BookServiceImpl() {
        ...
        logger.info("BookServiceImpl initialized with default BookDaoImpl");
    }
    ...
    public BookServiceImpl(BookDao bookDao) {
        ...
        logger.info("BookServiceImpl initialized with provided BookDao");
    }
    ...
    public boolean deleteBook(Book book) {
        logger.info("deleteBook() called for book id={} title='{}'", book.getId(), book.getTitle());
    ...
    public boolean changeBook(Book book) {
        logger.info("changeBook() called for book id={} title='{}'", book.getId(), book.getTitle());
    ...
    public Page<Book> findAll(Pageable pageable) {
        logger.info("findAll() called to retrieve all books");
    ...
    public boolean saveBookWithAuthor(Book book, Author author) {
        logger.info("saveBookWithAuthor() called for book title='{}' author='{}'",
                book.getTitle(), author.getName());
        boolean result = bookDao.saveBookWithAuthor(book, author);
        if (result) {
            logger.info("Book and author saved successfully: bookId={} authorId={}",
                    book.getId(), author.getId());
        } else {
            logger.warn("Failed to save book with author: title='{}' author='{}'",
                    book.getTitle(), author.getName());
        }
        return result;
    }
