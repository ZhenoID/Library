...
public class AuthorController {
    ...
    public String listAuthors(Model model) {
        logger.info("GET /authors - fetching list of authors");
    ...
    public String showAddForm(Model model) {
        logger.info("GET /authors/new - displaying form to create a new author");
    ...
    public String saveAuthor(@ModelAttribute Author author) {
        if (author.getId() == null) {
            logger.info("POST /authors/save - creating new author: name='{}'", author.getName());
            authorService.save(author);
            logger.info("New author created with generated ID={}", author.getId());
        } else {
            logger.info("POST /authors/save - updating existing author: id={}, name='{}'",
                    author.getId(), author.getName());
            authorService.update(author);
            logger.info("Author updated: id={}", author.getId());
        }
    ...
    public String editAuthor(@PathVariable Long id, Model model) {
        logger.info("GET /authors/edit/{} - fetching author for edit", id);
    ...
    public String deleteAuthor(@PathVariable Long id) {
        logger.info("GET /authors/delete/{} - deleting author", id);
        authorService.delete(id);
        logger.info("Author deleted: id={}", id);
        return "redirect:/authors";
    }
}
