...
public class UserDaoImpl implements UserDao {
    ...
    public UserDaoImpl(DataSource ds) {
        this.ds = ds;
        logger.info("UserDaoImpl initialized with provided DataSource");
    }
    ...
    public UserDaoImpl() {
        this.ds = null;
        logger.info("UserDaoImpl initialized using default ConnectionPool");
    }
    ...
    public boolean save(User user) {
        ...
        logger.info("save(User) called for username='{}'", user.getUsername());
        try (Connection conn = getConnection();
            ...
            logger.debug("Executing INSERT: {} with username='{}', role='{}'",
            ...
            try (ResultSet keys = ps.getGeneratedKeys()) {
                if (keys.next()) {
                    ...
                    user.setId(newId);
                    logger.info("User saved with generated ID={} username='{}'", newId, user.getUsername());
                }
            }
            return true;
    ...
    public User findByUsername(String username) {
        ...
        logger.info("findByUsername() called for username='{}'", username);
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    logger.info("User found: id={}, username='{}', role='{}'",
    ...
    public boolean delete(User user) {
        ...
        logger.info("delete(User) called for id={}", user.getId());
        try (Connection conn = getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public User findById(Long id) {
        ...
        logger.info("findById() called for id={}", id);
        try (Connection conn = getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public boolean updateRole(Long id, String newRole) {
        ...
        logger.info("updateRole() called for id={} newRole='{}'", id, newRole);
        try (Connection conn = getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            boolean updated = ps.executeUpdate() > 0;
            if (updated) {
                logger.info("User role updated successfully: id={} newRole='{}'", id, newRole);
            } else {
